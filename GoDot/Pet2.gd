...
func show_mood(mood):
    match mood:
        "sad":
            $MoodEmoji.texture = load("res://assets/emoji_sad.png")
        "playful":
            $MoodEmoji.texture = load("res://assets/emoji_playful.png")
        "cheeky":
            $MoodEmoji.texture = load("res://assets/emoji_cheeky.png")
        "neutral":
            $MoodEmoji.texture = load("res://assets/emoji_neutral.png")
